        ...
        if (error) {
            $.ajax({
                ...
                success: function (result) {
                    ...
                    if(result.indexOf('mail sent') > -1){
                        $('input[type=text],textarea').each(function () {
                            $(this).val('');
                        });
                        $("#success-project-contact-form").html("We have received your query. We will get in touch very soon.");
...
$('.logout').bind('click', function(e){
    e.preventDefault();
    $.ajax({
        url: 'https://ercess.com/ajax_requests.php',
        type: 'POST',
        data: 'logout=1',
        beforeSend: function(){
        },
        success: function(response){
            if(response == 2){
                ...
                window.open('https://ercess.com/live/', '_self');
            }
        }
    });
});
